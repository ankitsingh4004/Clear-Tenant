package com.example.admin.workorderlandlord.Fragment;
...
import com.example.admin.workorderlandlord.Activity.CreateNewIssue;
import com.example.admin.workorderlandlord.Activity.LoginActivity;

import com.example.admin.workorderlandlord.Activity.MessageList;
...
public class HomeFragment extends Fragment {
   ...
   View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=(RecyclerView) v.findViewById(R.id.tenantRecyclerView);
        ...
        MessageBtn=(Button) v.findViewById(R.id.messageBtn);
        CreateIssueBtn=(Button) v.findViewById(R.id.createIssueBtn);
        ...
        CreateIssueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent2=new Intent(getActivity(), CreateNewIssue.class);
                ...
                public void onResponse(Call<List<ModelForTenantList>> call, Response<List<ModelForTenantList>> response) {
                    ...
                    if (response.isSuccessful()){
                        ...
                        if (modelForTenantLists.size() == 0){
                            tvRecordFound = (TextView)v.findViewById(R.id.tvRecordFound);
    ...
    public void calTenantResponse(List<ModelForTenantList>TenantLists){
        ...
        adapter = new AdapterForTenant(getActivity(),TenantLists);
